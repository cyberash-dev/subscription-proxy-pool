...
export const SUITE_FILES: ReadonlyArray<string> = [
	...
	"src/shared/observability/tests/StderrJsonLogger.test.ts",
	...
	"src/features/subscription-oauth/tests/OpenAiVerifyClassification.test.ts",
	...
	"src/features/proxy/tests/Proxy.providerRouting.test.ts",
	"src/features/proxy/tests/Proxy.openaiBridge.test.ts",
	"src/features/proxy/tests/Proxy.bridgeContract.test.ts",
